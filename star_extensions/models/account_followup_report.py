...
class AccountFollowupReport(models.AbstractModel):
    ...
    def _get_columns_name(self, options):
        ...
        headers = [{},
                   ...
                   {'name': _('Communication1'), 'style': 'text-align:right; white-space:nowrap;'},
    ...
    def get_po_ref(self,value):
        order_id = self.env['sale.order'].search([('name','=',value)])
        if order_id and order_id.p_o_ref:
            return order_id.p_o_ref
        else:
            return ''
    ...
    def _get_lines(self, options, line_id=None):
        ...
        for currency, aml_recs in res.items():
            ...
            for aml in aml_recs:
                ...
                po_ref = ''
                if invoice_origin:
                    po_ref = self.get_po_ref(invoice_origin) 
            ...
            if total_issued > 0:
                ...
                lines.append({
                    ...
                    'unfoldable': False,
                    'level': 3,
                    'columns': [{'name': v} for v in [''] * (4 if self.env.context.get('print_mode') else 5) + [_('Total Overdue'), total_issued]],
                })
